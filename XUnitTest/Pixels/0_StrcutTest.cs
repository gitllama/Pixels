...
namespace XUnitTest
{
    ...
    public class StructBench
    {
        ...
        [Benchmark] public Int16 ConverterOld() => BitConverter.ToInt16(bytes, 0);
        [Benchmark] public Int16 ConverterNew() => Unsafe.As<byte, Int16>(ref bytes[0]);

        [Benchmark] public Int24 Int24New() => new Int24(bytes[0], bytes[2], bytes[1]);
        [Benchmark] public Int24 Int24FromByte() => Int24.FromByte(bytes, 0);
    }
